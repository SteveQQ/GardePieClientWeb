...
import com.steveq.GardePieClientWeb.utils.PinsUtils;
...
public class ScanService implements MyService {
    @Override
    public ToClientResponse processRequest(FromClientRequest request) {
        ...
        System.out.println("SCAHN RESPONSE : " + response);
